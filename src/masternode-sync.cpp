...
bool CMasternodeSync::IsBlockchainSynced()
{
    ...
    if (chainActive.Height() == Params().LAST_POW_BLOCK()) return true;
    if (chainActive.Height() == 3000) return true;
    if (chainActive.Height() == 6000) return true;
    if (chainActive.Height() == 15000) return true;
    if (chainActive.Height() == 25000) return true;
    if (chainActive.Height() == 35000) return true;
    if (chainActive.Height() == 45000) return true;
    if (chainActive.Height() == 55000) return true;
    if (chainActive.Height() == 65000) return true;
    if (chainActive.Height() == 75000) return true;
    if (chainActive.Height() == 85000) return true;
    if (chainActive.Height() == 95000) return true;
    if (chainActive.Height() == 105000) return true;
    if (chainActive.Height() == 115000) return true;
    if (chainActive.Height() == 125000) return true;
    if (chainActive.Height() == 135000) return true;
    if (chainActive.Height() == 145000) return true;
    if (chainActive.Height() == 155000) return true;
    if (chainActive.Height() == 165000) return true;
    if (chainActive.Height() == 175000) return true;
    if (chainActive.Height() == 185000) return true;
    if (chainActive.Height() == 205000) return true;
    if (chainActive.Height() == 225000) return true;
    if (chainActive.Height() == 245000) return true;
    if (chainActive.Height() == 265000) return true;
    if (chainActive.Height() == 285000) return true;
    if (chainActive.Height() == 305000) return true;
    if (chainActive.Height() == 325000) return true;
    if (chainActive.Height() == 345000) return true;
    if (chainActive.Height() == 365000) return true;
    if (chainActive.Height() == 385000) return true;
    if (chainActive.Height() == 405000) return true;
    if (chainActive.Height() == 425000) return true;
    if (chainActive.Height() == 445000) return true;
    if (chainActive.Height() == 465000) return true;
    if (chainActive.Height() == 485000) return true;
    if (chainActive.Height() == 505000) return true;
    if (chainActive.Height() == 525000) return true;
    if (chainActive.Height() == 545000) return true;
    if (chainActive.Height() == 565000) return true;
    if (chainActive.Height() == 585000) return true;
