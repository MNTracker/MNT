...
/* Mnt  GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "MNT"
#define QAPP_ORG_DOMAIN "mnt.org"
#define QAPP_APP_NAME_DEFAULT "MNT-Qt"
#define QAPP_APP_NAME_TESTNET "MNT-Qt-testnet"
