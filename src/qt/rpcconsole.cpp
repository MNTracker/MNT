                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzMNTPathCustom = GetArg("-zmntbackuppath", "");
    ...
    if(!strzMNTPathCustom.empty()) {
        ui->wallet_customzmntbackuppath->setText(QString::fromStdString(strzMNTPathCustom));
        ui->wallet_customzmntbackuppath_label->setVisible(true);
        ui->wallet_customzmntbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzMNTPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the MNT RPC console.") + "<br>" +
