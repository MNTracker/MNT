...
extern UniValue setzmntseed(const UniValue& params, bool fHelp);
extern UniValue getzmntseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzmnt(const UniValue& params, bool fHelp);
extern UniValue dzmntstate(const UniValue& params, bool fHelp);
