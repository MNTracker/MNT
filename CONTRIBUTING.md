Contributing to MNT Core
============================

The MNT Core project operates an open contributor model where anyone is
...
The following applies to code changes to the MNT Core project, and is not to be
confused with overall MNT Network Protocol consensus changes.

Whether a pull request is merged into MNT Core rests with the project merge
...
Patches that change MNT consensus rules are considerably more involved than
...
Where a patch set proposes to change the MNT consensus, it must have been
...
The project leader is the release manager for each MNT Core release.
