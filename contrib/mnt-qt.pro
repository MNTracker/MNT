...
RESOURCES += src/qt/mnt.qrc src/qt/mnt_locale.qrc

TRANSLATIONS += src/qt/locale/mnt_bg.ts \
                src/qt/locale/mnt_de.ts \
                src/qt/locale/mnt_en.ts \
                src/qt/locale/mnt_es.ts \
                src/qt/locale/mnt_fi.ts \
                src/qt/locale/mnt_fr.ts \
                src/qt/locale/mnt_it.ts \
                src/qt/locale/mnt_ja.ts \
                src/qt/locale/mnt_pl.ts \
                src/qt/locale/mnt_pt.ts \
                src/qt/locale/mnt_ru.ts \
                src/qt/locale/mnt_sk.ts \
                src/qt/locale/mnt_sv.ts \
                src/qt/locale/mnt_vi.ts \
                src/qt/locale/mnt_zh_CN.ts \
                src/qt/locale/mnt_zh_TW.ts
