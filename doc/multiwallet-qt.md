...
In order to support loading of multiple wallets in mnt-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is mnt.cpp.
...
Changes to mnt.cpp
----------------------
mnt.cpp is the entry point into mnt-qt, and as such, will require some minor modifications to provide hooks for
