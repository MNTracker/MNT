...
#   c) node1 mines 32 blocks, so now node 0 has 60001mnt, node 1 has 4250mnt, node2 has none.
#   d) node0 sends 601 mnt to node2, in two transactions (301 mnt, then 300 mnt).
