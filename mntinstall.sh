...
CONFIGFOLDER='/root/.mnt'
COIN_DAEMON='mntd'
COIN_CLI='mnt-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/MNTracker/MNT/releases/download/v1.0.1/mnt_ubuntu.zip'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='MNTrackerCoin'
COIN_EXPLORER='http://91.205.173.246'
COIN_PORT=57175
RPC_PORT=57174
